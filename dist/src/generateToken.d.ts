...
type Response = Result<string, GenerateTokenError | UnexpectedError>;
/**
 * Generate a token
 ...
 */
export declare function generateToken(payload: GenericObject | string, secret?: string, expiresIn?: string): Response;
export {};
